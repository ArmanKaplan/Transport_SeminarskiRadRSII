...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XPlat.Device.Geolocation.LocationRetriever, XPlat.Device.Geolocation", LocationRetriever.class, __md_methods);
	}
	...
	public LocationRetriever ()
	{
		...
		if (getClass () == LocationRetriever.class)
			mono.android.TypeManager.Activate ("XPlat.Device.Geolocation.LocationRetriever, XPlat.Device.Geolocation", "", this, new java.lang.Object[] {  });
	}
