    ...
    public partial class migi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 1, 11, 22, 45, 25, 363, DateTimeKind.Local).AddTicks(4957), 1, "Mostar, Maršala Tita 94", "Mostar, Bišće polje", "Molim vas da budete tačni", false, false, 1, 1, null, false, "Tkanina" },
                    { 2, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(8798), 1, "Sarajevo, Ul. Šenoina br. 1", "Mostar, Bišće polje", "Molim vas da budete tačni", false, false, 1, 1, null, false, "Porculan" },
                    { 3, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9196), 1, "Sarajevo, Ul. Šenoina br. 1", "Stolac, Humska bb", "Molim vas da budete tačni", false, false, 2, 2, null, false, "Drva" },
                    { 4, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9289), 1, "Sarajevo, Ul. Šenoina br. 1", "Stolac, Humska bb", "Molim vas da budete tačni", true, false, 2, 2, null, false, "Drva" },
                    { 5, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9372), 1, "Stolac, Humska bb", "Sarajevo, Ul. Šenoina br. 1", "Molim vas da budete tačni", true, false, 2, 2, null, false, "Drva" },
                    { 8, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9462), 1, "Stolac, Humska bb", "Ljubinje, Bančići", "Molim vas da budete tačni", true, false, 2, 2, null, false, "Drva" },
                    { 6, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9619), 1, "Bihac, Nade Kalić", "Tuzla, Titova", "Molim vas da budete tačni", true, true, 2, 2, null, false, "Drva" },
                    { 7, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9710), 1, "Trebinje, Pridovci", "Zvornik, Divič", "Molim vas da budete tačni", true, true, 2, 2, null, false, "Drva" },
                    { 9, new DateTime(2021, 1, 11, 22, 45, 25, 368, DateTimeKind.Local).AddTicks(9794), 1, "Trebinje, Pridovci", "Kladanj, Buševo", "Molim vas da budete tačni", true, false, 2, 2, null, false, "Pelet" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 1, 11, 0, 0, 0, 0, DateTimeKind.Local), "Molim te drzi se dogovora.", 1 });
